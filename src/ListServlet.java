...
public class ListServlet extends HttpServlet {
    private final String PATH = "/WEB-INF/lib/KookyDB";
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            rset = stmt.executeQuery("SELECT users_id, display_name FROM users");

            StringBuilder html = new StringBuilder("<html><body>");

            while (rset.next()) {
                int id = rset.getInt("users_id");
                String nm = rset.getString(2);
                html.append("<p>User Id: ").append(id).append("<br>Display Name: ").append(nm).append("</p>");
            }
